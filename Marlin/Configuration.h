...
#define STRING_CONFIG_H_AUTHOR "(Dean Piper mUVe 3D, mUVe 1)" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {33.333333333333336,33.333333333333336,640,640}  // default steps per unit for mUVe 1
